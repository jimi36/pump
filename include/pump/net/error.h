...
#define LANE_EOPNOTSUPP EOPNOTSUPP            // 95 Operation not supported
#define LANE_EPFNOSUPPORT EPFNOSUPPORT    // 96 Protocol family not supported
#define LANE_EAFNOSUPPORT EAFNOSUPPORT    // 97 Address family not supported
...
#define LANE_ENETRESET ENETRESET        // 102 Connection dropped for resetting
...
#define LANE_ESHUTDOWN ESHUTDOWN  // 108 Cannot send after shutdown
#define LANE_ETOOMANYREFS ETOOMANYREFS  // 109 Too many references
