...
#ifndef pump_proto_quic_tls_types_h
#define pump_proto_quic_tls_types_h
...
const cipher_suite_type TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305 =
    TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256;
const cipher_suite_type TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305 =
...
const extension_type TLS_EXTENSION_SERVER_NAME =
    0;  // https://tools.ietf.org/html/rfc6066#section-3
const extension_type TLS_EXTENSION_MAX_FRAGMENT_LENGTH =
    1;  // https://tools.ietf.org/html/rfc6066
const extension_type TLS_EXTENSION_STATUS_REQUEST =
    5;  // https://tools.ietf.org/html/rfc4366#section-3.6
const extension_type TLS_EXTENSION_SUPPORTED_GROUPS =
    10;  // https://tools.ietf.org/html/rfc4492#section-5.1.1
         // https://tools.ietf.org/html/rfc8446#section-4.2.7
const extension_type TLS_EXTENSION_SUPPORTED_POINTS =
    11;  // https://tools.ietf.org/html/rfc4492#section-5.1.2
const extension_type TLS_EXTENSION_SIGNATURE_ALGORITHMS =
    13;  // https://tools.ietf.org/html/rfc5246#section-7.4.1.4.1
         // https://tools.ietf.org/html/rfc8446#section-4.2.3
const extension_type TLS_EXTENSION_ALPN =
    16;  // https://tools.ietf.org/html/rfc7301#section-3.1
const extension_type TLS_EXTENSION_SCT =
    18;  // https://tools.ietf.org/html/rfc6962#section-3.3.1
const extension_type TLS_EXTENSION_SESSION_TICKET =
    35;  // https://tools.ietf.org/html/rfc5077#section-3.2
const extension_type TLS_EXTENSION_PRE_SHARED_KEY =
    41;  // https://tools.ietf.org/html/rfc8446#section-4.2.11
const extension_type TLS_EXTENSION_EARLY_DATA =
    42;  // https://tools.ietf.org/html/rfc8446#section-4.2.10
const extension_type TLS_EXTENSION_SUPPORTED_VERSIONS =
    43;  // https://tools.ietf.org/html/rfc8446#section-4.2.1
const extension_type TLS_EXTENSION_COOKIE =
    44;  // https://tools.ietf.org/html/rfc8446#section-4.2.2
const extension_type TLS_EXTENSION_PSK_MODES =
    45;  // https://tools.ietf.org/html/rfc8446#section-4.2.9
const extension_type TLS_EXTENSION_CERTIFICATE_AUTHORITIES =
    47;  // https://tools.ietf.org/html/rfc8446
const extension_type TLS_EXTENSION_SIGNATURE_ALGORITHMS_CERT =
    50;  // https://tools.ietf.org/html/rfc8446#section-4.2.3
const extension_type TLS_EXTENSION_KEY_SHARE =
    51;  // https://tools.ietf.org/html/rfc8446#section-4.2.8
const extension_type TLS_EXTENSION_RENEGOTIATION_INFO =
    0xff01;  // https://tools.ietf.org/html/rfc5746#section-3.2
...
const std::vector<ssl::curve_group_type> supported_curve_groups = {ssl::TLS_CURVE_X25519,
                                                                   ssl::TLS_CURVE_P256,
                                                                   ssl::TLS_CURVE_P384,
                                                                   ssl::TLS_CURVE_P521};
