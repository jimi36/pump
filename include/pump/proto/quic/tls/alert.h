...
#ifndef pump_proto_quic_tls_alert_h
#define pump_proto_quic_tls_alert_h
...
#define DEFINE_TLS_ALERT(alert, code, desc) const static tls_alert_code alert = code;
...
DEFINE_TLS_ALERT(ALERT_DEVOMPRESSION_FAILURE, 30, "devompression failure")
...
DEFINE_TLS_ALERT(ALERT_BAD_CERTIFICATE_STATUS_RESPONSE,
                 113,
