...
namespace tls {
    ...
    struct client_hello_message {
        ...
        // Extension field.
        // Constrained clients may wish to use a certificate-status protocol such as 
        ...
        // Extension field.
        // A new extension "application_layer_protocol_negotiation" is defined and MAY
    ...
    struct server_hello_message {
        ...
        // "application_layer_protocol_negotiation" extension MAY return a suitable 
        // protocol selection response to the client. The server will ignore any 
        // protocol name that it does not recognize. A new ServerHello extension type.
        // https://tools.ietf.org/html/rfc7301#section-3.1
        std::string alpn;
