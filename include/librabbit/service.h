...
#ifndef librabbit_service_h
#define librabbit_service_h
...
namespace librabbit {
	...
	public:
		 ...
		 * Update channel
		 ********************************************************************************/
		bool awake_channel_tracker(poll::channel_tracker_sptr &tracker);
		 ...
		 * Get iocp handler
		 ********************************************************************************/
		net::iocp_handler get_iocp_handler() const;
