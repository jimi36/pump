...
#ifndef librabbit_utils_sort_template_h
#define librabbit_utils_sort_template_h
...
namespace librabbit {
	namespace utils {
		...
		**/
		 ...
		 * range is [left, right)
		**/
		template<typename T> void bubble_sort(const T* a, int32 left, int32 right)
		{
		 ...
		 * range is [left, right)
		**/
		template<typename T> void select_sort(const T* a, int32 left, int32 right)
		{
			int32 min_pos;
			for (int32 i = left; i < right; ++i)
			{
		 ...
		 * range is [left, right)
		**/
		template<typename T> void insert_sort(T* a, int32 left, int32 right)
		{
		 ...
		 * range is [left, right)
		**/
		template<typename T> int32 __median_pos(T* a, int32 left, int32 right)
		{
			int32 i = left;
			int32 j = right - 1;
			T pivot = a[left];
		 ...
		 * range is [left, right)
		**/
		template<typename T> void quick_sort(T* a, int32 left, int32 right)
		{
		...
		**/
		template<typename T> void __max_heapify(T* a, int32 s, int32 i)
		{
			int32 l = i * 2;
			int32 r = i * 2 + 1;
		 ...
		 * s      ---->   size of the array.
		**/
		template<typename T> void __bulid_max_heap(T* a, int32 s)
		{
		 ...
		 * s      ---->   size of the array.
		**/
		template<typename T> void heap_sort(T* a, int32 s)
		{
