...
FILE(GLOB_RECURSE LIB_HEADERS ${ROOT_DIR}/include/librabbit/*.h)
...
IF(WIN32)
    FOREACH(FILE_NAME ${LIB_ALL_FILES})
	    ...
	    ELSE("${FILE_NAME}" MATCHES ".h")
            FILE(RELATIVE_PATH REL_FILE_NAME "${ROOT_DIR}/include/librabbit" ${FILE_NAME})
	    ENDIF()
...
ADD_LIBRARY(${LIBRABBIT_NAME} SHARED ${LIB_ALL_FILES})
...
ELSEIF(WIN32)
    ...
    ENDIF()
ENDIF()
TARGET_LINK_LIBRARIES(${LIBRABBIT_NAME} ${LINK_LIBS})

IF(UNIX)
    INSTALL(DIRECTORY ${ROOT_DIR}/include/ DESTINATION /usr/local/include)
    INSTALL(TARGETS ${LIBRABBIT_NAME}
