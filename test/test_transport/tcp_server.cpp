...
public:
	...
	void on_accepted_callback(base_transport_sptr &&transp)
	{
		...
		cbs.read_cb = pump_bind(&my_tcp_acceptor::on_read_callback, this, transp.get(), _1, _2);
		cbs.stopped_cb = pump_bind(&my_tcp_acceptor::on_stopped_callback, this, transp.get());
		cbs.disconnected_cb = pump_bind(&my_tcp_acceptor::on_disconnected_callback, this, transp.get());
...
void start_tcp_server(const std::string &ip, uint16 port)
{
	...
	cbs.accepted_cb = pump_bind(&my_tcp_acceptor::on_accepted_callback, my_acceptor, _1);
	cbs.stopped_cb = pump_bind(&my_tcp_acceptor::on_stopped_accepting_callback, my_acceptor);
